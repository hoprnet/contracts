...
See the [wrapper's documentation](`HoprWinningProbabilityOracleEventsInstance`) for more details.*/
    ...
    >(
        ...
        HoprWinningProbabilityOracleEventsInstance::<P, N>::new(address, __provider)
    }
...
For more fine-grained control over the deployment process, use [`deploy_builder`] instead.*/
    ...
    > {
        HoprWinningProbabilityOracleEventsInstance::<P, N>::deploy(__provider)
    }
...
the bytecode concatenated with the constructor's ABI-encoded arguments.*/
    ...
    >(__provider: P) -> alloy_contract::RawCallBuilder<P, N> {
        HoprWinningProbabilityOracleEventsInstance::<P, N>::deploy_builder(__provider)
    }
