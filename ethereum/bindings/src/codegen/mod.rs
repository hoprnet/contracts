...
pub mod r#hopr_dummy_proxy_for_network_registry;
pub mod r#hopr_boost;
pub mod r#hopr_token;
pub mod r#hopr_ledger;
pub mod r#hopr_network_registry;
pub mod r#hopr_network_registry_events;
...
pub mod r#hopr_safe_proxy_for_network_registry;
pub mod r#hopr_staking_proxy_for_network_registry;
